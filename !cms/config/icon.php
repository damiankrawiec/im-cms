...
$icon = array(
    ...
    'button' => array(
        'save' => '<i class="fal fa-check"></i>',
        'cancel' => '<i class="fal fa-times"></i>',
    ...
    'menu' => array(
        ...
        'section' => '<i class="fal fa-file"></i>',
        'definition-object' => '<i class="fal fa-file-signature"></i>',
        'type' => '<i class="fal fa-tasks-alt"></i>',
        'type-property' => '<i class="fal fa-cube"></i>',
