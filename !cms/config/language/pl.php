...
$translation = array(
    ...
    'modal' => array(
        ...
        'change-type' => 'Wybierz nowy typ dla obiektu',
        'change-parent' => 'Wybierz nową sekcję nadrzędną',
    ...
    'message' => array(
        ...
        'change-type-success' => 'Typ obiektu został zmieniony poprawnie',
        'change-parent-success' => 'Nadrzędna sekcja została zmieniona poprawnie',
        'change-parent-main-success' => 'Bieżąca sekcja została ustawiona jako główna',
    ...
    'edit' => array(
        ...
        'image' => 'Obecne obrazy',
        'gallery' => 'Obecne obrazy w galerii',
    ...
    'fix' => array(
        ...
        'gallery' => 'Obrazy podłączone do galerii'
    ),
    'copy' => array(
...
$tableDefinition = array(
    ...
    'im_image' => array(
        ...
        'date_modify' => 'Zmodyfikowany',
        'status' => 'Status',
        'status_description' => 'Wyświetl nazwę i opis',
    ...
    'im_label_section' => array(
        ...
        'class' => 'Właściwości',
        'class_row' => 'Właściwości otoczenia',
        'description' => 'Opis techniczny',
        'date_create' => 'Utworzony',
        'date_modify' => 'Zmodyfikowany'
    ),
...
$tableDefinitionEvent = array(
    ...
    'im_object' => array(
        ...
        'section_search' => 'Przekierowanie wyszukiwarki do sekcji',
...
$tooltip = array(
    'im_object' => array(
        ...
        'package' => 'To pole zawiera definicję pakietu w postaci tekstu w formacie JSON. Poszczególne bloki to występujące w kolejności zdarzenia (dowolna ilość), każde zdarzenie musi zawierać pole [name], czyli nazwę pakietu z jakiego będzie korzystać. Nazwa pierwszego zdarzenia to [init]',
        'class' => 'To pole określa właściwość odpowiedzialną za to czy obiekt ma mieć unikalną klasę (zaawansowane)',
        'spec' => 'To pole może być wykorzystane jako parametr techniczny np. w pakietach (zaawansowane)',
        'section' => 'Pole, w którym należy określić do jakiej sekcji w serwisie ma prowadzić odsyłacz w obiekcie',
        'section_search' => 'Pole, w którym należy określić do jakiej sekcji w serwisie ma prowadzić wyszukiwarka (brak ustawienia oznacza przekierowanie do bieżącej sekcji)',
