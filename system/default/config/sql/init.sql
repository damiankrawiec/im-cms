...
insert into im_section values (null, 0, 'Strona główna', '', 'strona-glowna', 'Opis strony głownej', 'fal fa-home', '', '', 1, 'on', 'off', 'off', 'off', 'on', '', null, null);
insert into im_section values (null, 0, 'Kontakt', '', 'kontakt', 'Opis kontaktowy', 'fal fa-phone-alt', '', '', 2, 'on', 'off', 'off', 'off', 'on', '', null, null);
insert into im_section values (null, 2, 'Kontakt 1', '', 'kontakt-1', '', '', '', '', 1, 'on', 'off', 'off', 'off', 'on', '', null, null);
insert into im_section values (null, 2, 'Kontakt 2', '', 'kontakt-2', '', '', '', '', 2, 'on', 'off', 'off', 'off', 'on', '', null, null);
...
insert into im_type_property values (null, 8, 14, 'col-12', '', 1, 'on', '', null, null);

-- record, object

insert into im_object values (null, 1, 1, 2, 0, 'Przekierowanie na kontakt', 'Aktualność pierwsza na stronie głównej (prowadzi do sekcji "kontakt")', '', '',  '', '', '', '', '', '', '', '', '', '', '', 1, 'on', 'off', 'off', 'off', 'off', '', null, null, null);
insert into im_object values (null, 1, 1, 0, 0, '', 'Aktualność druga na stronie głównej', '', '', '', '', '', '', '', '', '', '', '', '', '', 2, 'on', 'off', 'off', 'off', 'off', '', null, null, null);
insert into im_object values (null, 2, 2, 0, 0, '', 'Atrybut firmy na stronie głównej', '', '', '', '', '', '', '', '', '', '', '', '', '', 1, 'on', 'off', 'off', 'off', 'off', '', null, null, null);
insert into im_object values (null, 1, 1, 0, 0, '', 'Aktualność na stronie kontakt', '', '', '', '', '', '', '', '', '', '', '', '', '', 3, 'on', 'off', 'off', 'off', 'off', '', null, null, null);
insert into im_object values (null, 2, 2, 0, 0, '', 'Atrybut firmy na stronie głównej, kontakt', '', '', '', '', '', '', '', '', '', '', '', '', '', 2, 'on', 'off', 'off', 'off', 'off', '', null, null, null);
insert into im_object values (null, 2, 2, 0, 0, '', 'Atrybut firmy na stronie głównej, kontakt', '', '', '', '', '', '', '', '', '', '', '', '', '', 3, 'on', 'off', 'off', 'off', 'off', '', null, null, null);
insert into im_object values (null, 3, 3, 0, 0, '', 'Slider', '', '', '', '', '', '', '', '', '', '', '', '', '', 1, 'on', 'off', 'off', 'off', 'off', '', null, null, null);
insert into im_object values (null, 4, 4, 0, 0, '', 'Menu', '', '', '', '', '', '', '', '', '', '', '', '', '', 1, 'on', 'off', 'off', 'off', 'off', '', null, null, null);
insert into im_object values (null, 5, 5, 0, 0, '', 'Submenu', '', '', '', '', '', '', '', '', '', '', '', '', '', 1, 'on', 'off', 'off', 'off', 'off', '', null, null, null);
insert into im_object values (null, 6, 6, 0, 0, '', 'Języki', '', '', '', '', '', '', '', '', '', '', '', '', '', 1, 'on', 'off', 'off', 'off', 'off', '', null, null, null);
insert into im_object values (null, 7, 7, 0, 0, '', 'Ciasteczka', '', '', '<div id="cookie"><i class="fad fa-cookie fa-2x float-left m-1"></i> Przeglądając niniejszy serwis internetowy, akceptujesz pliki cookies zgodnie z ustawieniami przeglądarki <button class="btn btn-dark">OK</button></div>', '', '', '', '', '', '', '', '', '', '', 1, 'on', 'off', 'off', 'off', 'off', '', null, null, null);
insert into im_object values (null, 8, 8, 0, 0, '', 'Nawigacja okruszkowa', '', '', '', '', '', '', '', '', '', '', '', '', '', 1, 'on', 'off', 'off', 'off', 'off', '', null, null, null);

-- record, object image

insert into im_image values (null, 0, 'Moon', 'What are you doing?', '1.jpg', '', 'on', 'on', 'off', 0, '', null, null);
insert into im_image values (null, 0, 'Winter tree', '', '2.jpg', '', 'on', 'on', 'off', 0, '', null, null);
insert into im_image values (null, 0, 'Cactuars', '', '3.jpg', '', 'on', 'on', 'off', 0, '', null, null);
insert into im_image values (null, 0, 'First slider', 'Content of first slider', 'slider-1.jpg', '', 'on', 'on', 'off', 0, '', null, null);
insert into im_image values (null, 0, 'Second slider', 'Content of second slider', 'slider-2.jpg', '', 'on', 'on', 'off', 0, '', null, null);
insert into im_image values (null, 0, 'Third slider', '', 'slider-3.jpg', '', 'on', 'on', 'off', 0, '', null, null);
