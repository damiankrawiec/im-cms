...
create table im_object (
    ...
    spec text collate utf8_polish_ci default '',-- spec field (tech, func)
    position int default 0,
    status varchar(3) default 'on',
    status_copy varchar(3) default 'off',
...
insert into im_translation_system values (null, 1,  'Pole wyszukiwarka', 'search-text', 'Wpisz słowa kluczowe oddzielone spacją', '', null, null);
